...
uint8_t SPI_Master_test(void)
{
 ...
 SPI1TXB = 0xFF;
    ...
    SPI1_Close();
# 133 "mcc_generated_files/examples/spi_master_example.c"
}
...
uint8_t SPI_Master_test_2(void)
{
 ...
 while(!PIR2bits.SPI1RXIF);
    buffer[1] = SPI1RXB;
    _delay((unsigned long)((20)*(16000000/4/4000000.0)));
    SPI1TXB = 0xAA;
 while(!PIR2bits.SPI1RXIF);
    buffer[2] = SPI1RXB;
 _delay((unsigned long)((20)*(16000000/4/4000000.0)));
 ...
 buffer[3] = SPI1RXB;
    ...
    SPI1_Close();
# 178 "mcc_generated_files/examples/spi_master_example.c"
    return 1;
